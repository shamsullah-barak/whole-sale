...
const PurchaseReturnCreate = () => {
  ...
  const [form, setForm] = useState({ purchaseId: "", returnQuantity: 1, returnQuantityType: "piece", returnReason: "" });
  ...
  return (
    <Paper elevation={0} sx={{ p: 3, border: "1px solid", borderColor: "divider" }}>
      <Typography variant="h6" sx={{ mb: 2 }}>Create Purchase Return</Typography>
      <Box component="form" onSubmit={handleSubmit}>
        <Stack spacing={2} direction="column">
          <TextField label="Purchase ID" name="purchaseId" value={form.purchaseId} onChange={handleChange} required />
